...
public interface ApiClient extends Closeable {
	 ...
	 * @return An ApiFuture wrapping an EventApiResponse, from which the HttpResponse can be obtained if necessary.
     */
	...
	/**
	 * Queries the Word of Mouth API to retrieve an offer to be displayed to the current user,
	 * at the given insertion point.
	 *
	 * @param insertionPoint The string id for this insertion point that was configured in Tapstream's dashboard.
	 ...
	 *
	 * @returns An ApiFuture wrapping a RewardApiResponse from which a List<Reward> can be obtained.
	 *
	 * <code><pre>
